  ...
  return (
    <footer className="mt-auto relative">
      ...
      <div className="py-8 px-4 text-center space-y-4">
        ...
        <div className="flex items-center justify-center gap-3 text-violet-300 dark:text-violet-700">
        ...
        {/* Author credit */}
        <p className="text-sm font-medium bg-gradient-to-r from-violet-500 to-orange-400 bg-clip-text text-transparent">
          by Rahul Sharma
        </p>
      </div>
    </footer>
