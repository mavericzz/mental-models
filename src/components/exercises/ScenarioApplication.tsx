...
export function ScenarioApplication({ exercise, onAnswer }: Props) {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-zinc-200/60 bg-white/70 p-5 shadow-sm backdrop-blur-sm dark:border-zinc-700/60 dark:bg-zinc-800/50">
